  ...
  return (
    <section className="relative pb-24 lg:pb-40 overflow-hidden">
      <img
        ...
        src="https://shuffle.dev/saturn-assets/images/headers/star-header-left.png"
        alt=""
      />
      <div className="hidden md:block absolute top-0 left-0 w-1/6 lg:w-2/6 h-full bg-[#F4F6F8]" />
      <nav className="relative py-6 bg-transparent mb-12 md:mb-24 z-50">
        <div className="container px-4 mx-auto">
          <div className="flex items-center relative">
            ...
            <Link href={"/"} className='text-2xl text-black font-bold'>workbodia</Link>
            ...
            <div className="w-full lg:w-2/5 px-4 mb-16 lg:mb-0">
              <div className="relative max-w-lg lg:max-w-md mx-auto lg:mx-0">
                <img
                  ...
                  src="https://shuffle.dev/saturn-assets/images/headers/image-header-3.png"
                  alt=""
                />
                ...
                <div className="md:flex mb-14 max-w-xs sm:max-w-sm md:max-w-none">
                  ...
                  <div className="max-w-md">
                    <p className="md:text-xl text-gray-600 font-semibold">
                      {"Saturn is a startup that's making the world a better place! We've been working on our mission since 2021"}
                    </p>
                  </div>
                </div>
                <div className="sm:flex items-center">
                  ...
                  >
                    ...
                    <div className="relative flex items-center justify-center">
                      <span className="mr-4">Job Listings</span>
                      <span>
                        <svg
                          width={8}
                          height={12}
